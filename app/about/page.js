...
export default function Page() {
  return (
    <>
      {/* =====================================================
          ABOUT PAGE - DESKTOP PROCESS LINE FIX
          Desktop: 01 → 02 line hidden
          Mobile: original line remains
          ===================================================== */}
      <style>{`
        ...
        <section className="section section--sage">
          <div className="container split">
            ...
            <div>
              ...
              {/* Desktop line removed, mobile preserved */}
              <div
                className="process-line about-process-line"
                style={{
