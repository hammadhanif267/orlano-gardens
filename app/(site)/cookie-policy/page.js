...
export default async function CookiePage() {
  const override=await getLegalRecord("Cookie Policy");
  if(override)return <LegalPage eyebrow="Legal · Cookies" title={override.title} summary={override.body.slice(0,180)} updated={override.effectiveDate} sections={legalSections(override)}/>;
  return (
    <LegalPage
