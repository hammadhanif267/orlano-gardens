...
export default async function Page() {
  const override=await getLegalRecord("Disclaimer");
  if(override)return <LegalPage eyebrow="Legal · Disclaimer" title={override.title} summary={override.body.slice(0,180)} updated={override.effectiveDate} sections={legalSections(override)}/>;
  return (
    <>
      <script
