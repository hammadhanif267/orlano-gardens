...
export default async function Page() {
  const override=await getLegalRecord("Accessibility");
  if(override)return <LegalPage eyebrow="Legal · Accessibility" title={override.title} summary={override.body.slice(0,180)} updated={override.effectiveDate} sections={legalSections(override)}/>;
  return (
    <>
      <script
