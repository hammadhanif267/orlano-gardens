...
export default async function PrivacyPage() {
  const override=await getLegalRecord("Privacy Policy");
  if(override)return <LegalPage eyebrow="Legal · Privacy" title={override.title} summary={override.body.slice(0,180)} updated={override.effectiveDate} sections={legalSections(override)}/>;
  return (
    <LegalPage
