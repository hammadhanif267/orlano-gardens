      ...
      <div className="container">
        <div className="site-footer__grid">
          ...
          <div className="footer-column"><strong>Explore</strong>
            <Link href="/projects">Projects</Link><Link href="/testimonials">Testimonials</Link><Link href="/pricing">Pricing</Link><Link href="/garden-guides">Garden Guides</Link><Link href="/faq">FAQ</Link><Link href="/site-map">Site Map</Link>
          </div>
          <div className="footer-column"><strong>Information</strong>
            <Link href="/about">About</Link><Link href="/contact">Contact</Link><Link href="/privacy-policy">Privacy Policy</Link><Link href="/terms-and-conditions">Terms + Conditions</Link><Link href="/cookie-policy">Cookie Policy</Link><Link href="/disclaimer">Disclaimer</Link><Link href="/accessibility">Accessibility</Link>
          </div>
        </div>
        <div className="site-footer__bottom">
          <span>© {currentYear} Orlano Gardens. Remote digital outdoor design.</span>
